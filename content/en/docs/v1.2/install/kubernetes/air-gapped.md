...
Подробнее см. в [руководстве по настройке Talm]({{% ref "/docs/v1.2/install/kubernetes/talm" %}}).
...
Подробнее см. в [руководстве по настройке `talosctl`]({{% ref "/docs/v1.2/install/kubernetes/talosctl" %}}).
