...
For the platform-level Velero used by cluster administrators to back up `VMInstance`/`VMDisk` resources from the management cluster, see [Backup Classes]({{% ref "/docs/v1.4/operations/services/backup-classes" %}}).
{{% /alert %}}
...
- [Backup Classes (platform admin)]({{% ref "/docs/v1.4/operations/services/backup-classes" %}})
