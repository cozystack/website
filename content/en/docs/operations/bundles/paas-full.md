...
data:
  ...
  expose-services: "api,dashboard,keycloak,cdi-uploadproxy,vm-exportproxy"
```
...
| `expose-services` | Comma-separated list of services to expose to the internet. Possible values: `api,dashboard,keycloak,cdi-uploadproxy,vm-exportproxy` |
